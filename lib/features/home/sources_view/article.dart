    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Text(article.title?? "", style: GoogleFonts.inter(fontSize: 16,
          ...
          Row(
            children: [
              Expanded(
                child: Text(article.author ?? "", style: GoogleFonts.inter(fontSize: 12.sp,
                    color: ColorsManager.grey,
                    fontWeight: FontWeight.w500),),
              ),
              
              Expanded(
                child: Text(article.publishedAt?? "", style: GoogleFonts.inter(fontSize: 12.sp,
                    color: ColorsManager.grey,
                    fontWeight: FontWeight.w500),),
              )
